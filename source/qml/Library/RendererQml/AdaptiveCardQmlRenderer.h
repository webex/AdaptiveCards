...
namespace RendererQml
{
    ...
    private:
        ...
        static std::shared_ptr<QmlTag> GetCalendar(std::shared_ptr<AdaptiveRenderContext> context, const std::string textFieldId, const std::string stringDateFormat, const std::string minimumDate, const std::string maximumDate);
    };
}
