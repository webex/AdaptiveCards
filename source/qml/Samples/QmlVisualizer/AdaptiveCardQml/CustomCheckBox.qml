...
CheckBox {
        ...
        contentItem:RowLayout{
            ...
            TextEdit{
                ...
                onActiveFocusChanged:{if (activeFocus) { textEditFocussed(customCheckBoxTitle); accessibleText = getText(0,length);}}
        ...
        onActiveFocusChanged:{customCheckBox.colorChange(customCheckBox, false);if(activeFocus){Accessible.name = getAccessibleName() + text}}
        Component.onCompleted:{
            customCheckBox.colorChange(customCheckBox, false);}

        function onButtonClicked(){checked = !checked;}
        function getContentText(){ return customCheckBoxTitle.getText(0, customCheckBoxTitle.length);}
