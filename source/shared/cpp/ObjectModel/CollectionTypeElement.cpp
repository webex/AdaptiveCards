...
void CollectionTypeElement::ConfigPadding(const ParseContext& context)
{
    ...
    const bool padding = ((GetBackgroundImage() == nullptr && GetStyle() != ContainerStyle::None && (context.GetParentalContainerStyle()!= GetStyle())) || GetStyle() == ContainerStyle::Emphasis);
    SetPadding(padding);
}
