...
class ACRCollectionViewTests: XCTestCase {
    ...
    func testImageSetDefaultSize() {
        ...
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 200, height: 200))
    ...
    func testImageSetSizePriority() {
        ...
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 300, height: 300))
    }
    
    func testCollectionViewImageExplicitHeight() {
        let image = FakeImage.make(pixelHeight: 120)
        collectionView = ACRCollectionView(rootView: rootView, parentView: parentView, imageSet: FakeImageSet.make(imageSize: .large, images: [image]), hostConfig: hostConfig, collectionLayout: collectionViewLayout)
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 120, height: 120))
    }
    ...
    func testCollectionViewImageExplicitWidth() {
        ...
        collectionView = ACRCollectionView(rootView: rootView, parentView: parentView, imageSet: FakeImageSet.make(imageSize: .large, images: [image]), hostConfig: hostConfig, collectionLayout: collectionViewLayout)
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 140, height: 140))
    }
    ...
    func testCollectionViewImageExplicitWidthAndHeight() {
        ...
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 140, height: 120))
    }
    ...
    func testCollectionViewItemSizeNotExcedeParentWidth() {
        ...
        XCTAssertEqual(collectionView.collectionView(collectionView.collectionView, layout: collectionViewLayout, sizeForItemAt: IndexPath(item: 0, section: 0)), NSSize(width: 50, height: 120))
    }
    ...
    func testCollectionViewHeight() {
        ...
        let calculatedHeight = CGFloat(numberOfRows * imageDimenion) + CGFloat((numberOfRows - 1)) * minItemSpacing
    ...
    func testCollectionViewHorizontalSpacingLayout() {
        ...
        let firstElementCalculatedFrame = NSRect(x: 0, y: 0, width: imageDimenion, height: imageDimenion)
        
        // second element will be layout after firstElement with a space of minItemSpacing
        let secondElementCalculatedFrame = NSRect(x: imageDimenion + Int(minItemSpacing), y: 0, width: imageDimenion, height: imageDimenion)
        ...
        let thirdElementCalculatedFrame = NSRect(x: 0, y: imageDimenion + Int(minItemSpacing), width: imageDimenion, height: imageDimenion)
