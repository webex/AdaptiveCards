...
class ACRTextFieldTests: XCTestCase {
    ...
    func testSetErrorColors() {
        ...
        XCTAssertEqual(textField.layer?.borderColor, config.inputFieldConfig.errorMessageConfig.borderColor?.cgColor)
        XCTAssertEqual(textField.layer?.backgroundColor, config.inputFieldConfig.errorMessageConfig.backgroundColor?.cgColor)
    }
