...
class RootViewController: NSViewController, NSTableViewDelegate, NSTableViewDataSource, NSComboBoxDelegate, NSComboBoxDataSource {
    ...
    private func setupButtonConfig() {
        ...
        let buttonConfig = ButtonConfig(positive: positive, destructive: destructive, default: `default`, inline: inline, font: NSFont.systemFont(ofSize: 14, weight: .semibold), buttonContentInsets: NSEdgeInsets(top: 5, left: 10, bottom: 5, right: 10), chevronUpImage: ButtonConfig.default.chevronUpImage, chevronDownImage: ButtonConfig.default.chevronDownImage)
